...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Handle UserManagementClientException
    @ExceptionHandler(UserManagementClientException.class)
    public ResponseEntity<?> handleUserManagementClientException(UserManagementClientException ex) {
        LOGGER.error(ex.getMessage(), ex);
